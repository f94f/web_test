      ...
      <div class="surface">
        ...
        <label class="block b6" for="book1">
          <div class="block-inner">
            ...
            <div class="bottom"></div>
            <div class="front">
              <div class="spine">The Color Chucknorris</div>
            </div>
            <div class="left"></div>
            <div class="right" data-title="The Color Chucknorris">
              <div class="cover"></div>
              <div class="contents">
                <h1>Chapter 1</h1>
...
$blocks:
  ...
  (6,3,2, 2,10,14, #bf3e22, true),
  (8,3,2, 2,10,14, #0e4326, true),
  (10,3,2, 2,11,14, #0066cc, true),
  (12,3,2, 2,11,14, #0f7b7e, true),
  (14,3,2, 2,10,14, #084e6f, true),
  (16,3,2, 2,11,14, #0b0823, true),
